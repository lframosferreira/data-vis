...
df_dict["sportsref"] = df_dict["sportsref"].drop(
    columns=[
        "Day",
        "Time",
        "Date",
...
df_dict["sportsref"] = df_dict["sportsref"].rename(
    columns={"xG": "xG_Home", "xG.1": "xG_Away"}
)
df_dict["sportsref"]["xG_diff"] = (
    df_dict["sportsref"]["xG_Home"] - df_dict["sportsref"]["xG_Away"]
)
...
layout = html.Div(
    [
        ...
        html.P(
            "Essa visualização calcula a chance de um time fazer ou tomar um gol a partir de uma janela móvel com base nas rodadas do campeonato.",

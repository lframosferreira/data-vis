...
from interface.src.components import (
    elo_time_series_plot,
    elo_time_series_dropdown,
    radar_plot_players,
    radar_plot_players_dropdown,
    radar_plot_positions_dropdown,
    radar_plot_positions,
    shots_plot,
    shots_plot_dropdown,
)
